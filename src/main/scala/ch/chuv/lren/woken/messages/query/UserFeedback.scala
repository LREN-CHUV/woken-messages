...
object FeedbackImportance extends Enumeration {
  type FeedbackImportance = Value

  val info: FeedbackImportance    = Value("info")
  val warning: FeedbackImportance = Value("warning")
}

import FeedbackImportance._
